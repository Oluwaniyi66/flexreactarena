...
function Product({ id, image, title, price, discount, description, item }) {
    ...
    return (
        <div>
            {
                cartMessage ? <span className='cart-message' style={{ marginLeft: "15%", fontSize: "14px", backgroundColor: "whitesmoke", color: "forestgreen", padding: "5px 10px" }}>{cartMessage}</span> : ""
            }
